        ...
        <v-expansion-panels accordion mandatory flat>
          <v-expansion-panel>
            ...
            <v-expansion-panel-content>
              <div class="tw-mb-4 tw-text-parchment-dim">
              ...
              <div class="tw-max-h-96 tw-table-auto tw-overflow-y-auto">
                <table class="tw-w-full tw-text-left tw-text-parchment">
                  <thead>
                    <tr class="tw-bg-leather tw-font-medium">
                      <th
                        class="tw-sticky tw-top-0 tw-z-10 tw-bg-leather tw-pb-4"
                      >
                        Name
                      </th>
                      <th
