...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/events/{eventId}/lists/undo-assign": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "The token returned by the assignment being undone",
                        "name": "payload",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/events/{eventId}/lists/{listId}/items/{itemId}/assignee": {
            "put": {
                ...
                "responses": {
                    "200": {
                        "description": "affected counts the entries written; undoToken is present only when the write cascaded, and is what POST /lists/undo-assign takes",
                        "schema": {
                            "type": "object",
                            "properties": {
                                "affected": {
        ...
        "/events/{eventId}/lists/{listId}/items/{itemId}/move": {
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Destination list, the new order, and optionally the item's current parent to keep it nested",
                        "name": "payload",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/events/{eventId}/my-lists": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "List name and kind (text|location|checklist)",
                        "name": "payload",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/events/{eventId}/my-lists/{listId}": {
            "delete": {
                "consumes": [
                    "application/json"
                ],
        ...
        "/events/{eventId}/my-lists/{listId}/items": {
            "post": {
                "consumes": [
                    "application/json"
                ],
        ...
        "/events/{eventId}/my-lists/{listId}/items/{itemId}": {
            "put": {
                "consumes": [
                    "application/json"
                ],
        ...
        "/events/{eventId}/my-lists/{listId}/items/{itemId}/checked": {
            "put": {
                "consumes": [
                    "application/json"
                ],
        ...
        "/events/{eventId}/my-notes": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/routes.personalNoteResponse"
                        }
                    }
                }
            },
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "The whole note, as markdown",
                        "name": "payload",
                        "in": "body",
                        "required": true,
                        "schema": {
    ...
    "definitions": {
        ...
        "routes.personalNoteResponse": {
            ...
            "properties": {
                ...
                "updatedAt": {
                    "description": "A POINTER so an unwritten note serializes as null rather than as the\nepoch, which would render as \"Saved 01:00\" on a note nobody has saved.",
                    "type": "integer"
                }
            }
        }
